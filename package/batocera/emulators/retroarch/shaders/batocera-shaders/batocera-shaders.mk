...
define BATOCERA_SHADERS_INSTALL_TARGET_CMDS
	...
	# sets
	for set in retro scanlines enhanced curvature zfast flatten-glow mega-bezel-zfast mega-bezel-easymode mega-bezel-gdv mega-bezel-advanced; do \
	...
	ln -s $(TARGET_DIR)/userdata/shaders $(TARGET_DIR)/usr/share/batocera/shaders/downloaded
endef
